...
void lcd_disp_f_o_meansure_menu(u32 f,u32 sum)
{
	u8 dis_lcd_Hz[20];
	u8 dis_lcd_Sum[20];
	...
	sprintf((char*)dis_lcd_Hz,"f:%10d",f);
	sprintf((char*)dis_lcd_Sum,"sum:%8d",sum);
	
	LCD_ShowString(20,40,200,24,24,"Paper Num measure:");	
	LCD_ShowString(30,70,200,16,16,"Frequency");
	LCD_ShowString(120,70,200,16,16,dis_lcd_Hz);
	LCD_ShowString(30,100,200,16,16,"Paper Num");
	LCD_ShowString(120,100,200,16,16,dis_lcd_Sum);
				 
}

void lcd_disp_adc_menu(uint16_t adcx)
{
	float temp;
